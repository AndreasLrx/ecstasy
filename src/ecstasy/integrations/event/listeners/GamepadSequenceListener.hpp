...
namespace ecstasy::integration::event
{
    ...
    class GamepadSequenceListener {
      public:
        ...
        /// @since 1.0.0 (2024-03-27)
        ///
        GamepadSequenceListener(const std::vector<Gamepad::Button> &sequence, Callback callback);
        ...
        ///
        /// @return Gamepad::Button Key held if any, @ref Gamepad::Button::Unknown otherwise.
        ///
        /// @author Andréas Leroux (andreas.leroux@epitech.eu)
        /// @since 1.0.0 (2024-03-27)
        ///
        constexpr Gamepad::Button getHeldKey() const
        {
            return _heldButton;
        }
        ...
        ///
        /// @return const std::vector<Gamepad::Button>& A const reference to the validated keys vector.
        ///
        /// @author Andréas Leroux (andreas.leroux@epitech.eu)
        /// @since 1.0.0 (2024-03-27)
        ///
        constexpr const std::vector<Gamepad::Button> &getValidatedKeys() const
        {
