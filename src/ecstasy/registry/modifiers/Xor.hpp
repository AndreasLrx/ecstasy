...
{
    ///
    /// @brief Placeholder for @ref ecstasy::query::modifier::Xor "Xor".
    ///
    ...
    ///
    /// @brief Placeholder for @ref ecstasy::query::modifier::Xor "Xor". This extended version allows to specify the
    /// AutoLock.
    ///
